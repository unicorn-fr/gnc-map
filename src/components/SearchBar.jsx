...
// Supprime accents, majuscules et espaces superflus pour la comparaison
...
function scoreSite(site, q, commercialName) {
  ...
  // Champs textuels avec leur poids
  const fields = [
    [site.name,    12],
    [site.company, 10],
    [site.city,     7],
...
export default function SearchBar({ sites, allCommercials, getColor, onSelectSite, onClose }) {
    ...
    >
      ...
      <div className="bg-white shadow-2xl">
        <div className="flex items-center gap-3 px-4 pt-4 pb-3">
          ...
          />
          {query ? (
            <button onClick={() => setQuery('')} className="p-1.5 hover:bg-gray-100 rounded-lg">
